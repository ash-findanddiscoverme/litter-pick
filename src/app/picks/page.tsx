      ...
      <main className="flex-1 pt-16 md:pt-[72px]">
        <div className="max-w-lg mx-auto px-4 py-8 space-y-6">
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              <h1 className="font-display text-2xl md:text-3xl font-bold text-loam">Join a Litter Pick</h1>
              <p className="text-sm text-weathered mt-1">Join a pick or organise your own</p>
            </div>
            <Link href="/picks/new">
          ...
          {!loading && displayPicks.length === 0 && (
            <div className="text-center py-16">
              ...
              <h3 className="font-display text-lg font-semibold text-loam">No upcoming picks yet</h3>
              <p className="text-sm text-weathered mt-1">Be the first to organise one in your area!</p>
              <Link href="/picks/new" className="inline-block mt-6">
                <Button>Organise a pick</Button>
              </Link>
            </div>
          )}
        </div>
